...
void main() async {
  ...
  // Run `flutterfire configure` in the `mobile/` directory to generate
  // the real lib/firebase_options.dart.  Until then DummyFirebaseOptions
  // allows the app to compile without google-services.json present.
